...
export class SettingsView extends LitElement {
    ...
    constructor() {
        ...
        this.handleUseEchoMindKey = this.handleUseEchoMindKey.bind(this)
                    ...
                    .map(([id, config]) => {
                        ...
                        <div class="provider-key-group">
                            ...
                            <input type="password" id="key-input-${id}"
                                placeholder=${loggedIn ? "Using EchoMind's Key" : `Enter ${config.name} API Key`} 
        ...
        return html`
            <div class="settings-container">
                <div class="header-section">
                    <div>
                        <h1 class="app-title">EchoMind</h1>
                    ...
                    <div class="bottom-buttons">
                        ${this.firebaseUser
                            ? html`
                                ...
                                `
                            : html`
                                <button class="settings-button half-width" @click=${this.handleUseEchoMindKey}>
                                    <span>Login</span>
                                </button>
                                `
                        }
