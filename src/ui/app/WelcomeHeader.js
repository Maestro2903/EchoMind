...
export class WelcomeHeader extends LitElement {
        ...
        return html`
            <div class="container">
                ...
                <div class="header-section">
                    <div class="title">Welcome to EchoMind</div>
                ...
                <div class="option-card">
                    ...
                    <div class="option-content">
                        ...
                        <div class="option-description">
                            100% free with EchoMind's OpenAI key<br/>No personal data collected<br/>Sign up with Google in seconds
                        </div>
                    </div>
                ...
                <div class="footer">
                    EchoMind does not collect your personal data —
    ...
    openPrivacyPolicy() {
        ...
        if (window.api?.common) {
            window.api.common.openExternal('https://echomind.com/privacy-policy');
        }
    }
}
